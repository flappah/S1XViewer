...
{
    public class S111DCF4V12DataParser : HdfDataParserBase, IS111DCF4V12DataParser
    {
        ...
        public S111DCF4V12DataParser(IDatasetReader datasetReader, IGeometryBuilderFactory geometryBuilderFactory, IS111ProductSupport productSupport, IOptionsStorage optionsStorage)
        {
