...
{
    public class S104DCF8V11DataParser : HdfDataParserBase, IS104DCF8V11DataParser
    {
        ...
        public S104DCF8V11DataParser(IDatasetReader datasetReader, IGeometryBuilderFactory geometryBuilderFactory, IS104ProductSupport productSupport, IOptionsStorage optionsStorage)
        {
        ...
        public override async Task<IS1xxDataPackage> ParseAsync(string hdf5FileName, DateTime? selectedDateTime)
        {
            ...
            (long horizontalCRS, string utmZone) = RetrieveHorizontalCRS(hdf5S104Root, hdf5FileName);
            if (horizontalCRS <= 0)
            {
            ...
            if (selectedWaterLevelFeatureElement != null)
            {
                ...
                Hdf5Element? positioningElement = selectedWaterLevelFeatureElement.Children.Find(nd => nd.Name.LastPart("/") == "Positioning");
