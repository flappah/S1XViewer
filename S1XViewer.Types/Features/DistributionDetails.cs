...
{
    public class DistributionDetails : InformationFeatureBase, IDistributionDetails, IS128Feature
    {
        ...
        public IContactAddress[] ContactAddress { get; set; } = Array.Empty<ContactAddress>();
        ...
        public override IFeature DeepClone()
        {
            return new DistributionDetails
            {
                ...
                Telecommunications = Telecommunications == null
                    ? Array.Empty<Telecommunications>()
