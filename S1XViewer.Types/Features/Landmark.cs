...
namespace S1XViewer.Types.Features
{
    public class Landmark : GeoFeatureBase, ILandmark, IS123Feature
    {
        ...
        public override IFeature FromXml(System.Xml.XmlNode node, System.Xml.XmlNamespaceManager mgr, string nameSpacePrefix = "")
        {
            ...
            var categoryOfLandmarkNodes = node.SelectNodes($"{(String.IsNullOrEmpty(nameSpacePrefix) ? "" : $"{nameSpacePrefix}:")}categoryOfLandmark", mgr);
            ...
            var functionNodes = node.SelectNodes($"{(String.IsNullOrEmpty(nameSpacePrefix) ? "" : $"{nameSpacePrefix}:")}function", mgr);
